(function() {
  var BPromise, constructSynsetData, corpus, createWordNetTree, csv, data, delim, fs, getCorpusSynsets, getCorpusTree, mime, mime_type, pickSynsets, program, thresholdTree, util;
