...
createWordNetTree = function(corpus, options) {
  var fPrunedDocTrees, progressCreateDocTree, queue, queuedPushing, vocab, wordArrays, wordTreshold, _ref2;
  wordTreshold = options.threshold ? options.threshold : 1;
  _ref2 = getCorpusSynsets(corpus), wordArrays = _ref2.wordArrays, vocab = _ref2.vocab;
