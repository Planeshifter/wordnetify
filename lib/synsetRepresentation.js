(function() {
  var BPromise, DICTIONARY, EXCEPTIONS, MORPHY_SUBSTITUTIONS, Parallel, ProgressBar, WORDNETIFY_SYNSETS_TREE, WORD_LOOKUP, Word, arr, createDocTree, exports, fs, getCorpusSynsets, getWordSynsets, logger, memoize, morphy, str, synsetidArr, tm, util, word, _;
  ...
  getCorpusSynsets = function(docs) {
    var corpus, progressCreateDocTree, res, wordArrays;
    ...
    progressCreateDocTree = new ProgressBar('create document trees [:bar] :percent :etas', {
