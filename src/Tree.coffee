...
WORDNETIFY_SYNSETS_TREE_HASH_TABLE.reserve(
  Object.keys(WORDNETIFY_SYNSETS_TREE).length
)
...
module.exports = exports = {
  WORDNETIFY_SYNSETS_TREE_HASH_TABLE: WORDNETIFY_SYNSETS_TREE_HASH_TABLE,
  BROWN: BROWN
}
